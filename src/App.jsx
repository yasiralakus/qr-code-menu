        ...
        <div className="full-page">
            ...
            <main className="main">
                ...
                <details>
                    ...
                    <ul>
                        <li>Özel Soslu Tavuk Dürüm <span>120₺</span></li>
                        <li>Meksika Soslu Tavuk Dürüm <span>120₺</span></li>
                        <li>Cheddar Soslu Tavuk Dürüm <span>120₺</span></li>
                        <li>Köfte Dürüm <span>160₺</span></li>
                        <li>Kumru Dürüm <span>120₺</span></li>
                    </ul>
                </details>
                ...
                <details>
                    ...
                    <ul>
                        <li>Patatesli Gözleme <span>85₺</span></li>
                        <li>Peynirli Gözleme <span>85₺</span></li>
                        <li>Kaşarlı Gözleme <span>85₺</span></li>
                        <li>Sucuklu Gözleme <span>90₺</span></li>
                        <li>Sucuklu Kaşarlı Gözleme <span>95₺</span></li>
                    </ul>
                </details>
                ...
                <details>
                    ...
                    <ul>
                        <li>Sade Patso <span>80₺</span></li>
                        <li>Sosisli Patso <span>100₺</span></li>
                        <li>Sucuklu Patso <span>100₺</span></li>
                        <li>Köfteli Patso <span>150₺</span></li>
                        <li>Patates Tabağı <span>80₺</span></li>
                ...
                <details>
                    ...
                    <ul>
                        <li>Kaşarlı Tost <span>80₺</span></li>
                        <li>Sucuklu Tost <span>80₺</span></li>
                        <li>Karışık Tost <span>90₺</span></li>
                        <li>Kavurmalı Tost <span>150₺</span></li>
                    </ul>
                </details>
                ...
                <details>
                    ...
                    <ul>
                        <li>Kremalı Tavuklu Makarna <span>150₺</span></li>
                        <li>Köri Soslu Tavuklu Makarna <span>150₺</span></li>
                        <li>Acılı Kremalı Tavuklu Makarna <span>150₺</span></li>
                        <li>Soya Soslu Tavuklu Makarna <span>150₺</span></li>
                        <li>Fettuccine Alfredo <span>180₺</span></li>
                    </ul>
                </details>
                ...
                <details>
                    ...
                    <ul>
                        <li>Nohutlu Pilav <span>110₺</span></li>
                        <li>Nohutlu Tavuklu Pilav <span>130₺</span></li>
                        <li>Köfteli Pilav <span>250₺</span></li>
                        <li>Arnavut Ciğerli Pilav <span>180₺</span></li>
                        <li>Kavurmalı Pilav <span>250₺</span></li>
                        <li>Tavuk Soteli Pilav <span>220₺</span></li>
                    </ul>
                </details>
                ...
                <details>
                    ...
                    <ul>
                        <li>Çilekli Waffle <span>160₺</span></li>
                        <li>Muzlu Waffle <span>160₺</span></li>
                        <li>Full Karışık Waffle <span>160₺</span></li>
                        <li>Frambuazlı Waffle <span>180₺</span></li>
                        <li>Orman Meyveli Waffle <span>180₺</span></li>
                    </ul>
                </details>
